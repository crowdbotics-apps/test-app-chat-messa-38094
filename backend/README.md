...
## Project Structure
    ...
    ├── test_app_chat_messa_38094  # Django project configurations
...
1. Clone this repo and `cd test_app_chat_messa_38094`
...
2. Clone this repo and `cd test_app_chat_messa_38094`
